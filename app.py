...
# Redis configuration
redis_url = app.config["APPLICATION_REDIS_URI"]
...
def verify(number):
	...
	"""
	code = p2fa.getVerificationCode(number, app.config["MESSAGE_TEXT"])
	r.setex("number:%s:code" % number, code, app.config["CODE_VALIDITY"])
